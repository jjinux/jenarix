...
static const char *yyTokenName[] = {
  ...
  "shell_expression", "argument_list_of_lists", "expression_list",
...
** </ul>
*/
void jx_shell_Free(void *p,     /* The parser to be deleted */
...
#ifdef JX_SHELL_PARSER_DEBUG
      printf
        ("shell_expression ::= keyword(yymsp[-1].minor.yy0) argument_list(yymsp[0].minor.yy0)\n");
#endif
      yygotominor.yy0 = jx_list_new();
...
#ifdef JX_SHELL_PARSER_DEBUG
      printf
        ("expression_list(yygotominor.yy0) ::= expression_list(yymsp[-1].minor.yy0) expression(yymsp[0].minor.yy0)\n");
#endif
    }
...
#ifdef JX_JXON_PARSER_DEBUG
      printf
        ("list_of_associations(yygotominor.yy0) = list_of_associations(yymsp[-3].minor.yy0), primitive(yymsp[-2].minor.yy0) : expression(yymsp[0].minor.yy0)\n");
#endif
...
#ifdef JX_JXON_PARSER_DEBUG
      printf
        ("list_of_associations(yygotominor.yy0) = list_of_associations(yymsp[-4].minor.yy0), primitive(yymsp[-2].minor.yy0) : expression(yymsp[0].minor.yy0)\n");
#endif
...
#ifdef JX_JXON_PARSER_DEBUG
      printf
        ("list_of_associations(yygotominor.yy0) = primitive(yymsp[-2].minor.yy0) : expression(yymsp[0].minor.yy0)\n");
#endif
      yy_destructor(10, &yymsp[-1].minor);
    }
...
#ifdef JX_SHELL_PARSER_DEBUG
      printf
        ("inner_expression_list(yygotominor.yy0) = inner_expression_list(yymsp[-1].minor.yy0) , expression(yymsp[0].minor.yy0)\n");
#endif
    }
...
#ifdef JX_JXON_PARSER_DEBUG
      printf
        ("list_of_expressions(yygotominor.yy0) = list_of_expressions(yymsp[-2].minor.yy0) , expression(yymsp[0].minor.yy0)\n");
#endif
      yy_destructor(6, &yymsp[-1].minor);
    }
...
** None.
*/
void jx_shell_(void *yyp,       /* The parser */
