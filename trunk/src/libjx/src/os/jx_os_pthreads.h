...
{
  jx_int32 prev;
  __asm__ __volatile__("lock; cmpxchgl %k1,%2":"=a"(prev)
...
JX_INLINE jx_int32 jx_os_atomic32_exchange(jx_os_atomic32 * atomic, jx_int32 new_value)
{
#ifdef JX_OS_CAS
...
JX_INLINE int32_t jx_os_atomic32_exchange(jx_os_atomic32 * atomic, jx_int32 new_value)
{
  jx_os_atomic32 old_value;
  while(1) {
    old_value = *atomic;
...
JX_INLINE jx_status jx__os_thread_start(jx_os_thread * thread, jx_os_thread_fn func,
                                        void *arg)
{
